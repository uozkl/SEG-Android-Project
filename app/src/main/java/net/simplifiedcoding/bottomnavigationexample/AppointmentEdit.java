...
public class AppointmentEdit extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        int month_index=Integer.parseInt(appo_id.substring(2,4));
        int day_index=Integer.parseInt(appo_id.substring(4,6));
        int hrd_index=Integer.parseInt(appo_id.substring(6,8));
